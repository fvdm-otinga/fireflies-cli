## fireflies meetings update privacy

Update meeting privacy level (GraphQL: updateMeetingPrivacy)

```
fireflies meetings update privacy <id> <link|owner|participants|teammatesandparticipants|teammates> [flags]
```
