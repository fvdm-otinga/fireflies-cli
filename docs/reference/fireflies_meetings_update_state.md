## fireflies meetings update state

Pause or resume a live meeting recording (GraphQL: updateMeetingState)

```
fireflies meetings update state <id> <pause_recording|resume_recording> [flags]
```
