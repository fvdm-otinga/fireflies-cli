## fireflies realtime tail

Stream live transcript events for a meeting (Socket.IO)

### Synopsis

Connects to the Fireflies realtime Socket.IO endpoint and streams
...
```
fireflies realtime tail <meeting-id> [flags]
```
