...
Query Fireflies soundbites (bites)

### Options

```
  -h, --help   help for soundbites
```
...
* [fireflies soundbites create](fireflies_soundbites_create.md)	 - Create a soundbite from a meeting (GraphQL: createBite)
* [fireflies soundbites get](fireflies_soundbites_get.md)	 - Get a soundbite by ID (GraphQL: bite)
* [fireflies soundbites list](fireflies_soundbites_list.md)	 - List soundbites (GraphQL: bites)
