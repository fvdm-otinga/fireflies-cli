...
Fetch workspace analytics (GraphQL: analytics)

### Synopsis

Retrieve team and per-user meeting analytics. Use --since and --until to scope the time window.

```
fireflies analytics [flags]
```
