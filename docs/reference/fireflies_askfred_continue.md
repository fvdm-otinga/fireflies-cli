## fireflies askfred continue

Continue an existing AskFred conversation thread (GraphQL: continueAskFredThread)

```
fireflies askfred continue <thread-id> [question] [flags]
```
