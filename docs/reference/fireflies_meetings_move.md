## fireflies meetings move

Move a meeting to a channel (GraphQL: updateMeetingChannel)

```
fireflies meetings move <id> [flags]
```

### Options

```
      --channel string      Channel ID to move the meeting into (required)
